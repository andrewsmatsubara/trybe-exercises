...
// 3 - Esses parâmetros retornam um bloco: try (testa se o parâmetro string é a mesma daquela passada posteriormente, finalizando com a callback done()), catch (especifica uma resposta, caso uma exceção seja lançada, finalizando também com a callback done(error), onde error é a exceção em que o bloco tenta identificar);